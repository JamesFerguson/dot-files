...
function gup
{
  ...
  (
    ...
    then
      ...
      (rake db:abort_if_pending_migrations && echo "No new migrations.") || (echo "Migrations found, migrating and preparing test..." && rake db:migrate db:test:prepare && echo "Migrating cucumber env..." && RAILS_ENV=cucumber rake db:migrate)
